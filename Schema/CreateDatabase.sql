...
CREATE TABLE Author 
(EmailAddr VARCHAR (20) NOT NULL, Firstname VARCHAR(20) NOT NULL, Lastname VARCHAR(20) NOT NULL, PRIMARY KEY (EmailAddr));
...
ALTER TABLE Review ADD FOREIGN KEY (ReviewerID) REFERENCES Reviewer(EmailAddr);


CREATE TABLE Topic 
(ID INT unsigned NOT NULL AUTO_INCREMENT,  TopicName VARCHAR(50) NOT NULL, PRIMARY KEY (ID));
